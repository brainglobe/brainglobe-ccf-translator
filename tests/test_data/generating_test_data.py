...
np.savez_compressed(
    os.path.join(test_data_dir, "volumes", "gubra_mri_mouse_200um"), reference=reference
)
...
np.savez_compressed(
    os.path.join(test_data_dir, "volumes", "demba_P5_mouse_200um"),
    reference=reference,
    annotation=annotation,
)
...
np.savez_compressed(
    os.path.join(test_data_dir, "volumes", "demba_P4_mouse_200um"), reference=reference
)
...
np.savez_compressed(
    os.path.join(test_data_dir, "volumes", "demba_P7_mouse_200um"), reference=reference
)
...
np.savez_compressed(
    os.path.join(test_data_dir, "volumes", "demba_P8_mouse_200um"), reference=reference
)
...
np.savez_compressed(
    os.path.join(test_data_dir, "volumes", "demba_P56_mouse_200um"), reference=reference
)
...
np.savez_compressed(
    os.path.join(test_data_dir, "volumes", "demba_P28_mouse_200um"), reference=reference
)
...
np.savez_compressed(
    os.path.join(test_data_dir, "volumes", "demba_P14_mouse_200um"), reference=reference
)
